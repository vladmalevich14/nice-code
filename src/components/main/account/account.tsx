...
export const Account = ({activeContact, contactsDataForSort, setContactsDataForSort}: PropsType) => {
    ...
    const [nameValue, setNameValue] = useState<string>(user[0].name);
    ...
    return (
        <div className={styles.account}>
            ...
            <div className={styles.accountWall}>
                {switcherValue === 'Заметки' &&
                    <Notes notesDataForAdding={notesDataForAdding} setNotesDataForAdding={setNotesDataForAdding}/>}
                {switcherValue === 'Консультации' &&
                    <Consultations consultationsDataForAdding={consultationsDataForAdding}/>}
